...
export default function Navbar() {
  ...
  return (
    ...
    >
      ...
      >
        {/* Logo */}
        <Link href="/" className="flex items-center gap-3 group" aria-label="PROEMFLEX - Inicio">
          <div className="relative w-10 h-10 rounded-lg bg-gradient-to-br from-[#00F2FE] to-[#4FACFE] flex items-center justify-center font-display font-bold text-[#111820] text-lg transition-transform group-hover:scale-105">
            P
        ...
        <div className="flex items-center gap-4">
          ...
          >
            <motion.span
              ...
              className="block w-6 h-0.5 bg-white transition-colors group-hover:bg-[#00F2FE]"
            />
            <motion.span
      ...
      >
        <ul className="flex flex-col gap-4 px-6 pb-6">
          {navLinks.map((link) => (
            <li key={link.href}>
              <a
                ...
                className="font-display text-lg text-[#9CA3AF] hover:text-white transition-colors"
              >
                {link.label}
              </a>
            </li>
          ...
          <li>
            <a href="#contacto" className="btn-primary text-sm inline-block text-center w-full">
              Solicitar Cotización
            </a>
          </li>
        </ul>
