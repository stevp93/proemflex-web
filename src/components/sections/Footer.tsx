        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-12 gap-10">
          ...
          <div className="sm:col-span-2 lg:col-span-4 flex flex-col gap-4">
            ...
            <p className="text-[#9CA3AF] text-sm leading-relaxed max-w-sm">
              Alianza estratégica con más de 30 años de experiencia en empaques flexibles, ofreciendo soluciones integrales con altos estándares de calidad para la industria.
            </p>
          ...
          <div className="lg:col-span-2">
            ...
            <ul className="space-y-2">
              {[
                ...
                { label: "Calidad (BPF)", href: "/calidad" },
